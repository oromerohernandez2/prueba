...
<script type="text/javascript" src="http://localhost:8080/ci/assets/jquery/jquery-3.2.1.js"></script> 
<link rel="stylesheet" href="http://localhost:8080/ci/assets/jquery/bootstrap.min.css"></script> 
<script src="http://localhost:8080/ci/assets/jquery/bootstrap.min.js"></script> 
<script>
$(document).ready(function(){
	$("#submit").click(function(){
		$.ajax({
			type: "POST",
			url: "http://localhost:8080/ci/index.php/controlador_jquery/recibe",
